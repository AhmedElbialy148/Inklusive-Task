...
const ActivationForm = () => {
  ...
  const handleOnSubmit = async () => {
    ...
    if (newPassword !== confirmNewPassword) {
      setErrorStatus('Password does not match')
      return
    }  
      const data = {
        email,
      ...
      const res = await postRequest('/auth/activate', data);
      if (res.error) {
                    ...
                    <div className="lg:w-12/12 px-4 md:px-0">
                      <div className="md:p-12 md:mx-6">
                        <div className="text-center">
                          <h4 className="text-2xl font-semibold mt-1 mb-12 pb-1">Account Activation</h4>
                        </div>
                        <form onSubmit={(e) => {
                          e.preventDefault()
                          handleOnSubmit()
                        }}>
                          <p className="mb-4">Please activate your account</p>
                          <div className="mb-4">
                            <input
                              type="email"
